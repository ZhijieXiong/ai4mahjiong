...
if __name__ == "__main__":
    ...
    model_dir = "/root/autodl-tmp/mah_jiong_models"
    ...
    train_set = SLDataset(f"/root/code/ai4mahjiong/botzone_data/train/{args.mode}.pt", DEVICE)
    valid_set = SLDataset(f"/root/code/ai4mahjiong/botzone_data/valid/{args.mode}.pt", DEVICE)
